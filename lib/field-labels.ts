...
export const ARTIFACT_STATS_LABELS: Labels<ArtifactStats> = {
  arModelsAvailable: "Mô hình AR có sẵn",
  totalArtifact: "Tổng hiện vật",
  visitorsScannedToday: "Khách quét hôm nay",
};
...
export const MUSEUM_PROFILE_LABELS: Labels<MuseumProfile> = {
  ...
  openingHours: "Giờ mở cửa",
  closingHours: "Giờ đóng cửa",
  openingHoursEn: "Giờ mở cửa (tiếng Anh)",
  description: "Mô tả",
  descriptionEn: "Mô tả (tiếng Anh)",
};

export const MUSEUM_MANAGER_STATS_LABELS: Labels<MuseumManagerStats> = {
  totalVisitor: "Tổng tương tác",
  qrScansToday: "Lượt quét QR",
  offlineDownloads: "Lượt tải offline",
  averageListeningTime: "Thời lượng nghe TB",
};
