  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="w-full rounded-2xl py-3.5 pl-11 pr-12 text-sm outline-none transition-all duration-200"
        style={{
    ...
    <div className="flex h-screen overflow-hidden" style={{ background: C.bg }}>
      ...
      >
        ...
        >
          {/* Card */}
          <div
            className="rounded-[28px] px-10 py-9"
            style={{
              background: C.card,
              border: `1px solid ${C.border}`,
          ...
          >
            ...
            <div className="mt-6 space-y-3">
              <Field type="text" placeholder="Full Name" icon={User} />
              <Field type="email" placeholder="Email address" icon={Mail} />
              <Field
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.5 }}
              className="mt-5 space-y-2 rounded-2xl p-4"
              style={{
            ...
            >
              {BENEFITS.map((benefit, i) => (
                ...
                >
                  ...
                  >
                    <Check className="h-2.5 w-2.5" style={{ color: C.primary }} />
                  </div>
                  <span className="text-xs" style={{ color: C.muted }}>{benefit}</span>
                </motion.div>
              ))}
            </motion.div>

            {/* Create Account */}
            <motion.div whileHover={{ scale: 1.015 }} whileTap={{ scale: 0.975 }} className="mt-5">
              <Link
                href="/login"
