...
// Mock data — replace with: const res = await fetch(`${process.env.API_URL}/users`); return res.json();
...
// Sync version — used as initial state in client components
// When real API is ready: remove this and use useEffect + getUsers() instead
