...
export function CreateMuseumForm() {
  ...
  return (
    <div className="px-8 py-8">
      ...
      <h1 className="mb-8 text-3xl font-semibold">Create New Museum</h1>
      ...
      <div className="rounded-2xl border border-white/25 p-8">
        <div className="flex gap-8">
          ...
          <button
            ...
            className="flex h-52 w-52 shrink-0 flex-col items-center justify-center gap-2 rounded-xl border border-dashed border-white/30 bg-white/5 text-center transition-colors hover:border-white/50 hover:bg-white/10"
          >
            {imagePreview ? (
              <img
                src={imagePreview}
          ...
          <div className="flex-1 space-y-5">
            <div className="grid grid-cols-2 gap-4">
              <Field label="Museum Name" placeholder="Museum Name" />
              <Field label="Address" placeholder="Address" />
            </div>
            <div className="grid grid-cols-2 gap-4">
              <Field label="Contact Email" placeholder="Contact Email" type="email" />
...
function SelectField({ label }: { label: string }) {
  return (
    <div className="space-y-1.5">
      ...
      <select
        defaultValue=""
        className="w-full rounded-lg border border-white/20 bg-[#111] px-4 py-2.5 text-sm text-white/50 outline-none transition-colors focus:border-white/40"
      >
